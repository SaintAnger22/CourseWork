...
public class MainActivity extends AppCompatActivity implements CourseAdapter.OnCourseItemClickListener {
    ...
    private void initRecyclerView() {
        ...
        ItemsArraylist.add(new CourseDomain("C# Это просто!", "SkillBox", 100, "pic1", "C# по праву входит в топ лучших языков, которые интенсивно развиваются и пользуются большим спросом на рынке ИТ. C# применяется начиная от простейших программ и до огромных веб-сервисов, через которые каждый день проходят миллионы клиентов.","Русский", "Москва", "877484884"));
        ItemsArraylist.add(new CourseDomain("Kotlin для начинающих", "SkillBox", 80,  "picture2", "В ходе курса вы изучите язык программирования Котлин (Kotlin) с нуля, а также научитесь использовать его для построения Андроид программ. Вы обучитесь всем ключевым моментам работы с Kotlin и сможете выполнить легкий переход от Java к Kotlin.", "Английский", "Лондон", "987456125"));
        ItemsArraylist.add(new CourseDomain("Java Android Dev", "SkillBox", 120,  "picture3","Думаете над тем, чтобы начать путь мобильного разработчика? Предлагаем вашему вниманию курс «Разработка под Android для начинающих», созданный специалистами Google (владельцами Android и всего хорошего в мире ИТ)", "Русский", "Минск", "128789184"));
